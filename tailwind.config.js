  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "lava-glow": "0 0 20px rgba(255, 77, 26, 0.5)",
        "gold-glow": "0 0 15px rgba(232, 160, 32, 0.4)",
      },
      borderWidth: {
        3: "3px",
      },
      ...
      keyframes: {
        ...
        lavaPulse: {
          "0%, 100%": { boxShadow: "0 0 20px rgba(255, 77, 26, 0.3)" },
          "50%": { boxShadow: "0 0 40px rgba(255, 77, 26, 0.6)" },
        },
        flicker: {
          "0%, 100%": { opacity: "1" },
          "50%": { opacity: "0.8" },
