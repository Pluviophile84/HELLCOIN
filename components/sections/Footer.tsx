    ...
    >
      <style jsx>{`
        @keyframes ember-rise {
          ...
          100% {
            transform: translateY(-800px) translateX(var(--ember-x-offset)) scale(0.3);
            opacity: 0;
          }
        }
        .ember {
      ...
      <div className="relative z-10 mx-auto w-full max-w-[2400px] px-4 lg:w-[85%] 3xl:max-w-[2800px]">
        {/* Main content */}
            ...
            <div className="flex items-center gap-4">
              <div className="relative h-12 w-12 overflow-hidden rounded-lg md:h-14 md:w-14">
                <Image
                  ...
                  fill
                  sizes="80px"
                  className="object-contain drop-shadow-[0_0_10px_rgba(255,85,0,0.5)]"
                />
              </div>
