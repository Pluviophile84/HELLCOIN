    ...
    <section id="genesis" className="cave-texture relative bg-obsidian-900 px-4 py-32">
      ...
      >
        ...
        <div className="relative mx-auto max-w-4xl 3xl:max-w-5xl">
          ...
          <div className="relative rounded-xl border-3 border-black bg-obsidian-950/50 p-6 shadow-brutal transition-shadow duration-200 hover:shadow-[0_0_30px_rgba(255,85,0,0.5)] md:p-10 lg:p-12">
            {/* Top ornament */}
