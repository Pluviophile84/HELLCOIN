...
export const Ritual = () => {
 ...
 <button onClick={handleCopy} className="w-full md:w-auto min-w-[180px] bg-hell-red hover:bg-hell-orange text-white font-bold py-4 px-8 flex items-center justify-center gap-2 transition-all active:scale-95">
