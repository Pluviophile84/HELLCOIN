  ...
  return (
    <section id="ritual" className="cave-texture relative overflow-hidden bg-obsidian-900 py-32">
      ...
      <div className="pointer-events-none absolute left-1/2 top-1/2 z-0 -translate-x-1/2 -translate-y-1/2 select-none">
        <svg
          viewBox="0 0 100 100"
          className="h-[180vw] w-[180vw] animate-spin-slow text-hellfire-red motion-reduce:animate-none md:h-[1000px] md:w-[1000px]"
          style={{ opacity: 0.03 }}
          aria-hidden="true"
        >
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 3xl:max-w-6xl">
        ...
        >
          {steps.map((step, i) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-xl border-3 border-black bg-obsidian-800 shadow-brutal transition-shadow duration-200 hover:shadow-[0_0_30px_rgba(255,85,0,0.5)]"
            >
        ...
        >
          ...
          {/* Contract box */}
          <div className="rounded-xl border-3 border-black bg-obsidian-800 p-4 shadow-brutal transition-all duration-200 hover:shadow-[0_0_30px_rgba(255,85,0,0.7)] md:p-6">
            <div className="flex flex-col items-stretch gap-4 md:flex-row md:items-center">
              ...
              <button
                onClick={handleCopy}
                aria-live="polite"
                className={`flex w-full min-w-[160px] items-center justify-center gap-2 rounded-lg border-3 border-black px-6 py-4 font-heading text-lg font-bold text-white shadow-brutal transition-all duration-200 hover:translate-x-0.5 hover:translate-y-0.5 active:scale-95 md:w-auto ${
                  copied
                    ? "bg-green-500"
                    : copyError
                      ? "bg-red-500"
                      : "hellfire-bg hover:shadow-[0_0_30px_rgba(255,85,0,0.7)]"
                }`}
              >
