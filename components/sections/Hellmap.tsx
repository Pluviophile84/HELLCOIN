...
import { fadeInUp, viewportOnce, getVariants, getInitial, getWhileInView } from "@/lib/animations";
...
const phases = [
  ...
  },
  {
    ...
    tagline: "It's not a bear market if it never goes up.",
    details: [
          ...
          <div className="space-y-12 md:space-y-16">
            {phases.map((phase, i) => (
              ...
              >
                ...
                {/* Content card */}
                <div
                  className={`group flex-1 rounded-xl border-3 border-black bg-obsidian-800 shadow-brutal transition-all duration-200 hover:shadow-[0_0_30px_rgba(255,85,0,0.5)] md:w-[calc(50%-50px)] md:flex-none ${
