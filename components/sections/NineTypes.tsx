        ...
        >
          {types.map((type, i) => (
            <motion.div
              ...
              className="group relative flex flex-col items-center overflow-hidden rounded-xl border-3 border-black bg-obsidian-800 p-8 text-center shadow-brutal transition-shadow duration-200 hover:bg-lava-500/5 hover:shadow-[0_0_40px_rgba(255,85,0,0.5)]"
            >
              <type.icon
                strokeWidth={1}
