  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        "
      >
        {/* Constrain text so it never hugs the edges on ultra-wide */}
        <div className="w-full max-w-[90vw] md:max-w-[48rem] lg:max-w-[54rem] ml-auto mr-auto md:mr-0 space-y-4">
          {/* HERALD: ABANDON HOPE */}
          <motion.p
            ...
            className="
              font-terminal font-black uppercase tracking-[0.25em]
              text-[#ffae00] animate-pulse
              mx-auto md:mx-0
              text-[clamp(1.2rem,2.8vw,1.9rem)]
            "
          >
            ABANDON HOPE.
          </motion.p>
          ...
          <motion.div
            ...
            "
          >
            <p className="leading-relaxed text-[clamp(1rem,2.2vw,1.35rem)]">
        ...
        >
          ...
          <button
            ...
            className="
              ...
              order-2 md:order-1
              hover:text-[#ffae00]
              text-[clamp(0.9rem,1.7vw,1.1rem)]
            "
          >
            [ ENTER HELL ]
      ...
      {/* Bottom fog must stay under content */}
