    ...
    >
      <div className="absolute inset-0 z-0">
        <Image
          ...
          priority
          sizes="100vw"
          className="object-cover object-[40%_center] opacity-100 sm:object-[34%_center] md:object-[28%_center] lg:object-[22%_center] xl:object-[16%_center] 2xl:object-[10%_center]"
        />
      ...
      >
        {/* Shift whole content block toward center (left) without fighting Framer Motion transforms */}
        <div className="w-full md:-translate-x-16">
          <motion.h1
            initial={{ scale: 0.9, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            transition={{ type: "spring", duration: 1.5 }}
            className="text-glow mb-8 font-gothic text-hero-h1 leading-[0.9] text-hell-white drop-shadow-2xl md:ml-auto md:max-w-6xl"
          >
          ...
          <motion.div
            ...
            className="mx-auto max-w-4xl space-y-2 font-terminal text-hero-sub text-hell-white md:mx-0 md:ml-auto md:max-w-5xl md:space-y-0"
          >
          ...
          <motion.p
            ...
            className="mt-8 animate-pulse font-terminal text-hero-phrase uppercase tracking-widest text-flame md:ml-auto md:max-w-5xl"
          >
          ...
          <motion.div
            ...
            className="mt-12 flex w-full flex-col items-center justify-center gap-8 md:ml-auto md:max-w-5xl md:flex-row md:justify-end"
          >
            <button
              type="button"
