        ...
        >
          {mathItems.map((item, i) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-xl border-3 border-black bg-obsidian-800 p-6 shadow-brutal transition-shadow duration-200 hover:shadow-[0_0_30px_rgba(255,85,0,0.7)] md:p-8"
            >
              {/* Background icon */}
              <item.icon
                size={120}
