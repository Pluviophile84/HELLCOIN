...
export const ThePit = () => {
  return (
    <section
      id="the-pit"
      className="hellfire-bg relative flex min-h-[900px] items-center justify-center overflow-hidden py-32"
    >
          ...
          <div className="relative overflow-hidden rounded-xl border-3 border-obsidian-800 bg-obsidian-900/90 p-8 text-center backdrop-blur-md md:p-16">
            ...
            <div className="flex w-full justify-center">
              <a
                ...
                className="hellfire-bg group relative inline-flex w-full items-center justify-center gap-3 rounded-xl border-3 border-black px-6 py-3 font-heading text-xl text-white shadow-brutal transition-all duration-300 hover:translate-x-1 hover:translate-y-1 hover:shadow-[0_0_30px_rgba(255,85,0,0.7)] active:scale-95 md:w-auto md:px-12 md:py-4 md:text-3xl"
              >
