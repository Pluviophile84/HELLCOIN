          ...
          >
            {phase === "heaven" && (
              <motion.div
                key="heaven-content"
                exit={
                  reduceMotion ? { opacity: 0 } : { opacity: 0, scale: 1.5, filter: "blur(20px)" }
                }
            ...
            {phase === "burning" && (
              ...
              >
                <h1 className="text-cartoon mb-8 font-heading text-4xl leading-none tracking-tighter text-white drop-shadow-[0_5px_5px_rgba(0,0,0,0.8)] md:text-9xl">
                  REALITY CHECK
                </h1>
