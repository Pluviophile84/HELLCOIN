...
export const HellLoader = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative mb-8">
        <div className="relative h-24 w-24 overflow-hidden rounded-lg motion-safe:animate-loader-pulse md:h-32 md:w-32">
          <Image
            ...
            sizes="128px"
            priority
            className="object-contain drop-shadow-[0_0_30px_rgba(255,85,0,0.8)]"
          />
        </div>
      ...
      <div className="mt-8 h-1 w-[200px] overflow-hidden rounded-full bg-obsidian-800 motion-safe:animate-fade-in-delayed">
