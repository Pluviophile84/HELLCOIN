...
const heavenExpanded = "px-2.5 py-1.5 text-[11px] md:px-4 md:py-2 md:text-sm";
const heavenCompact = "px-2.5 py-1.5 text-[11px] md:px-3 md:py-1.5 md:text-sm";
  ...
  return (
    <div className="flex shrink-0 items-center gap-2 md:gap-4">
      ...
      <button
        ...
        className={cn(
          "flex items-center gap-2 whitespace-nowrap rounded-lg border-3 border-black bg-gradient-to-b from-pink-300 to-pink-400 font-body text-xs font-bold text-black shadow-brutal-sm transition-[padding,transform,box-shadow] duration-300 ease-out hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[0_0_30px_rgba(244,114,182,0.7)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-400 focus-visible:ring-offset-2 focus-visible:ring-offset-obsidian-950 md:text-sm",
      ...
      >
        <span
          className={cn(
            "h-2 w-2 rounded-full bg-white shadow-[0_0_5px_#fff]",
      ...
      <a
        ...
        className={cn(
          "hellfire-bg hidden whitespace-nowrap rounded-lg border-3 border-black text-center font-heading text-white shadow-brutal transition-[padding,transform,box-shadow,font-size] duration-300 ease-out hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[0_0_30px_rgba(255,85,0,0.7)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 focus-visible:ring-offset-obsidian-950 xl:block",
