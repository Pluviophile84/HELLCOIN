...
const linkStyles =
  "group relative font-body text-[15px] font-semibold uppercase tracking-wider text-lava-100 transition-colors hover:text-gold focus-visible:text-gold focus-visible:outline-none";
...
export const NavbarLinks = ({ links, onNavClick }: NavbarLinksProps) => {
  ...
  const handleMenuItemKeyDown = (e: React.KeyboardEvent<HTMLAnchorElement>, idx: number) => {
    if (e.key === "ArrowDown") {
      e.preventDefault();
        ...
        >
          ...
          {shouldRenderMenu && (
            <div
              ...
              className={cn(
                "absolute left-0 top-full z-50 min-w-[200px] pt-4 transition-all duration-180 ease-out",
