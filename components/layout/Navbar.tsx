...
export const Navbar = ({ onTriggerPaperHands }: { onTriggerPaperHands: () => void }) => {
  ...
  return (
    ...
    >
      {/* REVERTED TO STANDARD MAX-W-7XL (Removes 2xl scaling that caused overflow) */}
      <div className="max-w-7xl mx-auto px-4 flex justify-between items-center h-full">
        ...
        <div 
          ref={navRef} 
          className={cn(
            "hidden lg:flex items-center justify-center px-8 h-full relative flex-1 mx-4 transition-opacity duration-300",
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="lg:hidden fixed top-0 left-0 w-full h-[100vh] bg-hell-black/95 backdrop-blur-xl border-b border-hell-red/50 overflow-hidden shadow-2xl z-40 pt-[80px]"
          >
